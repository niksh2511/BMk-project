    ...
    public class UserClaim : IUserClaim
    {
        ...
        public int RoleId
        {
            get
            {
                ...
                return !string.IsNullOrWhiteSpace(role) ? Convert.ToInt32(role) : 0;
            }
        }
        public int OrganizationId
        {
            get
            {
                string organizationId = GetClaimValue("organizationId");
                return !string.IsNullOrWhiteSpace(organizationId) ? Convert.ToInt32(organizationId) : 0;
            }
        }
