        ...
        private static void Configure(string emailType, IServiceCollection serviceCollection, IConfiguration configuration)
        {
            switch (emailType)
            {
                ...
                case SENDGRID:
                    ...
                    var emailSection = configuration.GetSection("SendGrid");
                    var sendGridEmailConfiguration = new SendGridEmailConfiguration();
                    emailSection.Bind(sendGridEmailConfiguration);
